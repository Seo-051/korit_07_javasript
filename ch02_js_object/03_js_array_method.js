...
// 결과값 ['김사', '김오'];
// 두번째 argyment는 종료 인덱스 넘버입니다.

// filter()

/*
  filter() 메서드를 활용하여 words 배열 내에
  있는 단어의 길이가 5이상인 애들만 추출해서
  새로운 배열을 만들어 console에 출력하도록
  하겠습니다.
*/
let words = [
  "부산광역시",
...
console.log(pass);
/*
  이상에서 주의할 점은 persons를 가지고 새로운 배열을
  만들었는데, persons의 element의 자료형은 object이미로
  새로운 배열인 pass의 element도 여전히 object입니다.
  score들을 가지고 비교했다고 해서 점수들을 element로 
  삼는 것이 아니라
...
let sum = scores.reduce(function (total, currenValue) {
